...
export type ComfyErrorCode = 'IRC_CONNECTION_FAILED' | 'IRC_AUTH_FAILED' | 'EVENTSUB_CONNECTION_FAILED' | 'EVENTSUB_CONNECTION_LIMIT' | 'EVENTSUB_SUBSCRIPTION_FAILED' | 'P2P_CONNECTION_FAILED' | 'API_ERROR' | 'UNKNOWN';
