          ...
          if (messageData.type === "reward-redeemed") {
            ...
            var rewardObj = {
              ...
              maxPerUserPerStream: {
                ...
                maxPerUserPerStream:
                  reward.max_per_user_per_stream.max_per_user_per_stream,
              },
              globalCooldown: {
                enabled: reward.global_cooldown.is_enabled,
                globalCooldownSeconds:
                  reward.global_cooldown.global_cooldown_seconds,
              },
...
var comfyJS = {
  ...
  Say: function (message, channel) {
    if (client) {
      ...
      client.say(channel, message).catch(comfyJS.onError);
      return true;
    }
    return false;
  },
  ...
  Whisper: function (message, user) {
    if (client) {
      client.whisper(user, message).catch(comfyJS.onError);
      return true;
    }
    return false;
  },
  ...
  DeleteMessage: function (id, channel) {
    if (client) {
      ...
      client.deletemessage(channel, id).catch(comfyJS.onError);
      return true;
    }
    return false;
  },
  ...
  Init: function (username, password, channels, isDebug) {
    ...
    client.connect().catch(comfyJS.onError);
  ...
  Disconnect: function () {
    client.disconnect().catch(comfyJS.onError);
  },
